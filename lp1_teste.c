...
int main(){
    ...
    while(flag==1){//loop do menu
        ...
        }while(opcao<1 || opcao>6);//repete o scanf ate a opcao ser valida, contador
            ...
            case 1:
                ...
                do{
                    ...
                    do{
                        ...
                        int b=0, c=0;//incrementam posicao das letras

                        for(b=0; b<strlen(atividade[i]); b++){//vai corrigindo quando tiver mais de um espaço apos a palavra
                            if(upperAtividade[i][b]!=' '){//se for letra
                                corrigida[c]=upperAtividade[i][b];//recebe letra
                                if(upperAtividade[i][b+1]==' '){//se o proximo caractere for espaco
                                    corrigida[c+1]=' ';//recebe espaco
                                    c++;
                                }
                                c++;
                            }
                        }
                        if(corrigida[c-1]==' '){//se o ultimo caractere for espaco
                            corrigida[c-1]='\0';//recebe \0
                        }

                        strcpy(upperAtividade[i], corrigida);

                        for(int k=0; k<contador; k++){
                            igual=strcmp(upperAtividade[i],upperAtividade[k]);//recebe 0 caso sejam iguais
                            if(igual==0){
